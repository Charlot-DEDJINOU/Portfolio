...
import IconProjet from './icons/IconProjet.vue'
...
import { downloadCV, toggleMenu } from '~/utils/utils.js'
...
export default {
  ...
  setup() {
    ...
    const theme = ref(computed(() => store.theme))
...
<template>
  <div class="w-100 mt-5">
    ...
    >
      <IconSetting size="30" />
      <span class="d-inline-block mx-3 fw-light" :style="{ color: theme.colorprimary }">{{
        $t('preferences')
      }}</span>
    </div>
    <div class="mb-4">
